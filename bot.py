...
async def handle_start_message(update: Update, context: CallbackContext):
    ...
    user_data[chat_id]['start_message'] = update.message.text
    chat_name = user_data[chat_id]['name']
    chat_description = user_data[chat_id]['description']
    ...
    window.liveChatSettings = {{
        ...
        startMessage: '{user_data[chat_id]['start_message']}',
        chatId: '{chat_id}'
    }};
    (function(u) {{
